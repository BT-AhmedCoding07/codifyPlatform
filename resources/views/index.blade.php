            ...
            <div class="login-box">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 card">
                        <br>
                        <h3 class="header-title">Validation du paiement mensuelle</h3>
                        <form class="login-form" action="{{ route('payment.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                <input type="hidden" class="btn btn-primary btn-block" name="etudiants_id" value="{{request('verify')}}" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="slider-feature-card">
                                        ...
                                        <h3 class="slider-title">Plusieurs modes paiements</h3>
                                        <p class="slider-description">Nous offrons plusieurs mode de paiements simples et sécurisées pour effectuer des paiements partout dans le pays.</p>
                                    </div>
                                </div>
